...
def get_args():
    ...
    parser.add_argument('--trade_off', help='the trade-off method of proximity and diversity', type=str, default='WSD')
    parser.add_argument('--balance_tau', help='balance parameters', type=np.float32, default=0.01)
