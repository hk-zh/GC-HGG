...
MODEL_XML_PATH = 'R800_pick_and_place_obstacle_gravity_v2.xml'
...
class PickObstacleEnvV2(fetch_env.FetchEnv, gym_utils.EzPickle):
    def __init__(self, reward_type='sparse'):
        ...
        self.adapt_dict["field"] = [0.75, 0, 1.2-0.15, 0.25, 0.35, 0.2]
        self.adapt_dict["obstacles"] = [[0.75, 0, 1.075-0.15, .25, 0.04, .075]]
    ...
    #     self.sim.model.site_pos[site_id] = self.goal - sites_offset + np.array([0.0, 0.015, 0.0])
    #     self.sim.forward()